import "./perfilUsuario.js";
import "./simularPrestamo.js";
export class PageUsuario extends HTMLElement {
    constructor() {
        super();
        this.render();
    }
    ...
    render() {
        const styles = `
            ...
            .navbar {
                ...
                box-shadow: 0 2px 15px rgba(49, 28, 237, 0.2);
                padding: 0;
                border-bottom: 2px solid #1c1fed;
                height: 80px;
                position: sticky;
                top: 0;
                z-index: 1000;
            ...
            .navbar-brand img {
                ...
                width: auto;
                object-fit: contain;
                filter: drop-shadow(0 0 5px rgba(49, 28, 237, 0.2));
            ...
            .nav-link:hover {
                color: #1c1fed;
                background: rgba(49, 28, 237, 0.2);
            }

            .nav-link.active {
                color: #ffffff;
                background: #1c1fed;
                box-shadow: 0 0 15px rgba(49, 28, 237, 0.2);
            }
            ...
            .content-container {
                ...
                border: 1px solid rgba(49, 28, 237, 0.2);
            }
            ...
            .racing-lines {
                ...
                opacity: 0.05;
                background: 
                    linear-gradient(45deg, transparent 48%, #1c1fed 49%, #1c1fed 51%, transparent 52%),
                    linear-gradient(-45deg, transparent 48%, #1c1fed 49%, #1c1fed 51%, transparent 52%);
            ...
            <div class="fullscreen-container">
                <nav class="navbar">
                    <div class="container-fluid">
                        ...
                        <ul class="nav-menu">
                            <li class="nav-item">
                                <a class="nav-link active" href="#" data-section="prestamo">Simular Préstamo</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="content-container">
                    <div id="prestamo" style="display:block;">
                        <simular-prestamo></simular-prestamo>
                    </div>
        ...
        this.querySelectorAll('.nav-link').forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                if (section === 'perfil') {
                    ...
                    const oldPerfilComponent = this.querySelector('perfil-usuario');
                    if (oldPerfilComponent) {
                        oldPerfilComponent.remove();
                    }

                    // Creamos un nuevo componente perfil-users
                    const newPerfilComponent = document.createElement('perfil-usuario');
                ...
                ['prestamo', 'perfil'].forEach(containerName => {
...
customElements.define("page-usuario", PageUsuario)