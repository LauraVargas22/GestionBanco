...
export class loginUser extends HTMLElement {
    ...
    render() {
        ...
        <style>
            ...
            max-width: 400px;
            margin: 100px auto;
            box-shadow: 0 0 30px rgba(0, 26, 255, 0.1);
            ...
            letter-spacing: 2px;
            text-shadow: 2px 2px 4px rgba(25, 0, 255, 0.3);
            }
            ...
            outline: none;
            border-color: #0011ff;
            box-shadow: 0 0 10px rgba(0, 26, 255, 0.1);
            }

            button {
            background: linear-gradient(45deg, #0011ff, #0014cc);
            color: white;
            padding: 15px;
            border: none;
            border-radius: 5px;
            ...
            box-shadow: 0 7px 20px rgba(0, 26, 255, 0.1);
            }
    ...
    addEventListeners() {
        ...
        this.querySelector('#btnIngresar').addEventListener('click', async (e) => {
            ...
            const identidad = this.querySelector('#identidad').value.trim();
